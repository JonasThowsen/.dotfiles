...
(let* (;; From your vim colorscheme (dark)
  ...
  (custom-theme-set-faces
   ...
   ;; Syntax (grayscale - subtle white/gray variation)
   `(font-lock-comment-face ((t (:foreground "#706B80" :slant italic))))
   `(font-lock-string-face  ((t (:foreground "#A8A0A8"))))
   `(font-lock-keyword-face ((t (:foreground "#E8E0E8" :weight bold))))
   `(font-lock-function-name-face ((t (:foreground ,fg))))
   `(font-lock-variable-name-face ((t (:foreground "#C8C0C8"))))
   `(font-lock-type-face ((t (:foreground "#D0C8D0"))))
   `(font-lock-constant-face ((t (:foreground "#B8B0B8"))))
   `(font-lock-builtin-face ((t (:foreground "#D8D0D8"))))
